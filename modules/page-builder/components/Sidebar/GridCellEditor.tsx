      ...
      <div>
        ...
        <div className="flex items-center gap-2">
          ...
          <input
            ...
            className="flex-1 px-2 py-1.5 text-xs font-mono bg-slate-100 dark:bg-slate-800 border-0 rounded focus:outline-none focus:ring-1 focus:ring-blue-500 text-slate-900 dark:text-white"
          />
