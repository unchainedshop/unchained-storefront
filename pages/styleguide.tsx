...
const sampleReviews = [
  {
    ...
    review: "This exceeded all my expectations. Would recommend.",
  ...
  },
  {
    ...
    rating: 4,
    title: "Great value",
    review: "Good product overall. Works as described.",
  ...
  const componentSections = [
    ...
    },
    {
      ...
      components: [
        ...
        {
          name: "StarRating",
          description: "Star rating display with half-star support",
          examples: [
            <StarRating key="star-1" rating={5} size="sm" />,
            <StarRating key="star-2" rating={4.5} size="md" />,
            <StarRating key="star-3" rating={3} size="lg" />,
            <StarRating key="star-4" rating={4.2} size="md" showValue />,
          ],
        },
      ],
    },
    ...
    },
    {
      ...
      components: [
        ...
        {
          name: "ProductReviews",
          description: "Customer reviews section with rating summary",
          examples: [
            <div key="reviews-1" className="w-full max-w-2xl">
