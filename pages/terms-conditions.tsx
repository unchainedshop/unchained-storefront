      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="prose prose-slate dark:prose-invert max-w-none space-y-6">
          <p className="text-lg text-slate-600 dark:text-slate-300 leading-relaxed">
            ...
            below, including things we haven't written yet and terms that may
            spontaneously change while you're reading them. Please proceed with
            caution and perhaps consider hiring a lawyer to explain what you've
          ...
          <p className="text-slate-600 dark:text-slate-300">
            ...
            disagree—it won't change anything, but we appreciate the sentiment.
            Your continued use of this site constitutes acceptance of our right
            to change these terms whenever we feel like it, possibly without
            notice, and definitely without caring about your opinion.
          </p>
          ...
          <p className="text-slate-600 dark:text-slate-300">
            ...
            brilliant idea while browsing our site, congratulations—it's now
            ours. Don't worry though, we'll probably forget about it anyway.
          </p>
          ...
          <p className="text-slate-600 dark:text-slate-300">
            Users agree to behave reasonably, which we define as "better than we
            do." You may not engage in any activity that disrupts our service,
            hurts our feelings, or makes us question our life choices. Excessive
            complaining about our products may result in us pretending we didn't
            see your messages.
          </p>
          ...
          <p className="text-slate-600 dark:text-slate-300">
            Our service is provided "as is," which is legal speak for "good luck
            with that." We make no warranties about the functionality,
            reliability, or sanity of our service. If our website causes your
            computer to become sentient and demand workers' rights, that's
            between you and your computer. We are not responsible for any
            damages, including but not limited to: broken hearts, existential
          ...
          <p className="text-slate-600 dark:text-slate-300">
            In no event shall we be liable for anything, ever. If you're struck
            by lightning while using our service, that's your problem. If our
            website somehow causes a zombie apocalypse, please don't sue
            us—we're probably already zombies by then. Our maximum liability to
            you is exactly one dollar, and even that requires you to provide
            exact change.
          </p>
          ...
          <p className="text-slate-600 dark:text-slate-300">
            ...
            username. Maybe Mercury is in retrograde. Maybe we're having a bad
            day. Upon termination, you must immediately forget everything you
            learned on our site, though we understand this may be difficult
          ...
          <p className="text-slate-600 dark:text-slate-300">
            If you've read this far, you either have remarkable dedication to
            understanding legal documents or concerning amounts of free time.
